function add_person() {
    ...
    var foglioAttivo2 = SpreadsheetApp.getActive().getSheetByName("prova2");
    ...
    foglioAttivo2.getRange(3, foglioAttivo2.getLastColumn() + 1, numRows - 2, 1).setValues(valori);
    foglioAttivo2.getRange(3, foglioAttivo2.getLastColumn() + 1, numRows - 2, 1).setValues(valori1);
    ...
    str1_for1 = lettere_ex + "$3:" + lettere_ex + "$" + foglioAttivo2.getLastRow();
    str1_for2 = col_req + "$3:" + col_req + "$" + foglioAttivo2.getLastRow();
  
    str2_for1 = lettere_ex2 + "$3:" + lettere_ex2 + "$" + foglioAttivo2.getLastRow();
    str2_for2 = col_req2 + "$3:" + col_req2 + "$" + foglioAttivo2.getLastRow();
  
    for1 = example.getFormula().toString();
    for1 = for1.replace(str1_for1, str1_for2);
    target_for1.setFormula(for1);
  
    for2 = example2.getFormula().toString();
